...
export function AxonLandingPage({ onEnter }: AxonLandingPageProps) {
  return (
    <div className="relative h-screen w-full overflow-hidden flex flex-col bg-[#d7d6df] text-[#1B133C]">
      <video
      ...
      <header className="relative z-10 flex justify-center px-4 pt-4 md:pt-6">
        ...
        >
          <a href="#top" aria-label="Axon home" className="flex items-center">
          ...
          <div className="hidden items-center gap-6 text-sm font-medium md:flex">
            ...
            <a href="#plans" className="transition-opacity hover:opacity-60">Plans</a>
      ...
      <main id="top" className="relative z-10 mx-auto mt-8 flex w-full max-w-5xl flex-1 flex-col items-center px-6 text-center md:mt-16">
