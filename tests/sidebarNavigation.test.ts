...
const expectedNavigation: Array<{
  ...
  },
  {
    key: 'injection',
    label: '注汽管理',
    tabs: ['channelingProjectManagement', 'injectionOptimization', 'measureWellSelection', 'injectionPlan', 'injectionConstruction', 'injectionSoakTransfer', 'measures', 'measureAnalysis'],
    labels: ['注窜项目台账', '注汽优化预测', '选井决策', '方案与计划', '施工监控', '焖井转抽', '生产响应', '效果评价'],
  },
  {
    key: 'analysis',
    label: '生产分析',
